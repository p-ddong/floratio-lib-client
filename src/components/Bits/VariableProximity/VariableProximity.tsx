...
interface VariableProximityProps<T extends HTMLElement = HTMLElement>
...
const VariableProximity = forwardRef<HTMLSpanElement, VariableProximityProps<HTMLElement>>(
  (props, ref) => {
    const {
      label,
